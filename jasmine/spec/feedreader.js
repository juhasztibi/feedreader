...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
        ...
        */
        it('each feed have url', function() {
            allFeeds.forEach(function(feedItem){
                ...
                expect(feedItem.url).toMatch(/^(http|https):\/\//);
        ...
        */
        it('each feed have name', function() {
            allFeeds.forEach(function(feedItem){
    ...
    describe('New Feed Selection', function() {
        ...
        */
        ...
        beforeEach(function(done) {
            loadFeed(0, function() {
                originalFeedDom = $('.feed').html();
                loadFeed(1, done);
            });
        });

        it('should be different', function() {
            var newFeedDom = $('.feed').html();
            if (typeof newFeedDom !== 'undefined' && typeof originalFeedDom !== 'undefined') {
                expect(newFeedDom).not.toBe(originalFeedDom);
            }
        });
